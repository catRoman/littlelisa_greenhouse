...
#define SENSOR_QUEUE_PRIORITY               7
#define SENSOR_QUEUE_CORE_ID                1

#define SENSOR_PREPROCESSING_STACK_SIZE     3000
#define SENSOR_PREPROCESSING_PRIORITY       6
#define SENSOR_PREPROCESSING_CORE_ID        1


#define SENSOR_PREPARE_TO_SEND_STACK_SIZE   3000
#define SENSOR_PREPARE_TO_SEND_PRIORITY     6
#define SENSOR_PREPARE_TO_SEND_CORE_ID      1


#define SENSOR_POSTPROCESSING_STACK_SIZE    3000
#define SENSOR_POSTPROCESSING_PRIORITY      6
#define SENSOR_POSTPROCESSING_CORE_ID       1


#define SENSOR_SEND_TO_RAM_STACK_SIZE       3000
#define SENSOR_SEND_TO_RAM_PRIORITY         6
#define SENSOR_SEND_TO_RAM_CORE_ID          1


#define SENSOR_SEND_TO_SD_DB_STACK_SIZE     3000
#define SENSOR_SEND_TO_SD_DB_PRIORITY       6
#define SENSOR_SEND_TO_SD_DB_CORE_ID        1


#define SENSOR_SEND_TO_SERVER_DB_STACK_SIZE 3000
#define SENSOR_SEND_TO_SERVER_DB_PRIORITY   6
#define SENSOR_SEND_TO_SERVER_DB_CORE_ID    1


#define SENSOR_QUEUE_MEM_CLEANUP_STACK_SIZE 3000
#define SENSOR_QUEUE_MEM_CLEANUP_PRIORITY   6
#define SENSOR_QUEUE_MEM_CLEANUP_CORE_ID    1

#define SENSOR_SEND_TO_WEBSOCKET_SERVER_STACK_SIZE 8192
#define SENSOR_SEND_TO_WEBSOCKET_SERVER_PRIORITY   6
