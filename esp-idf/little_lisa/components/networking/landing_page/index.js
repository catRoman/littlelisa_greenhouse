(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();document.querySelector(".network-info");document.querySelector(".sensor-data-node-box");document.querySelector(".section-sensor-data");const M=document.querySelector(".log-output"),B=document.querySelector(".log-refresh"),R=document.querySelector(".sensor-refresh");let i,l;document.querySelector(".ota-log");const v=document.querySelector(".ota-status"),y=document.querySelector(".ota-status-info"),h=document.querySelector(".ota-status-reset"),U=document.getElementById("fileInput");let q=[];const x=new Set(null);let m="node",S;const _=document.getElementById("uploadBtn"),H=document.getElementById("uploadForm");H.addEventListener("submit",async e=>{e.preventDefault(),_.disabled=!0;const t=U.files[0],o="ota/update_prop";v.classList.toggle("hidden");try{const s=await fetch(o,{method:"POST",headers:{"Content-Type":"application/octet-stream"},body:t});if(s.ok){const n=await s.text();console.log(n),y.textContent="Upload Complete..."}else throw new Error(`Status: ${s.status}`)}catch(s){console.error("Error uploading file:",s),setTimeout(()=>{y.textContent="SD save failed...",h.textContent=s},1e4),v.classList.toggle("hidden"),_.disabled=!1}});B.addEventListener("touchend",e=>{i!==void 0&&(i.close(),console.log("refreshing log socket..."),M.value="Refreshing esp log stream...",setTimeout(()=>$(S),3e3))});R.addEventListener("touchend",e=>{l!==void 0&&(l.close(),setTimeout(()=>k(S),3e3))});const C=document.querySelector(".icon-open"),T=document.querySelector(".icon-close"),L=document.querySelector(".menu"),g=document.querySelector("main");document.querySelector(".nav-btn.close");const P=document.querySelectorAll(".nav-btn");P.forEach(e=>{e.addEventListener("touchend",function(t){t.stopPropagation;const o=[...this.classList];switch(o[o.length-1]){case"dev_btn":u(".device-info");break;case"net_btn":u(".network-info");break;case"db_btn":u(".sd-db-info");break;case"sys_btn":u(".system-health");break;case"ota_btn":S.module_info.type=="controller"?u(".ota-update"):console.log("Disabled for nodes. TODO: only render button for controller");break;case"close":C.classList.toggle("hidden"),g.classList.toggle("hidden"),L.classList.toggle("hidden"),g.style.pointerEvents="none",setTimeout(()=>{g.style.pointerEvents="auto"},100);break}})});C.addEventListener("touchend",()=>{C.classList.toggle("hidden"),g.classList.toggle("hidden"),L.classList.toggle("hidden")});function u(e){console.log(e),L.classList.toggle("hidden"),document.querySelector(e).classList.toggle("hidden"),T.classList.toggle("hidden")}T.addEventListener("touchend",()=>{const e=document.querySelector(".menu-select");Array.from(e.children).forEach(t=>{!t.classList.contains("hidden")&&!t.classList.contains("head-icon")&&(console.log(t.classList[0]),u(`.${t.classList[0]}`))})});function F(e){const t=document.querySelector(`${e} > .sensor-summary`);t.addEventListener("click",function(o){(o.target===this||this.contains(o.target))&&(t.nextElementSibling.classList.toggle("hidden"),t.querySelector(".node-title").classList.toggle("green"))})}async function W(){try{const e=await fetch("/api/deviceInfo.json");if(!e.ok)throw new Error("Network response wasnt very cool");const t=await e.json();ne(t)}catch(e){console.log(e)}}async function V(){try{const e=await fetch("/api/wifiApConnectInfo.json");if(!e.ok)throw new Error("Network response wasnt very cool");const t=await e.json();Q(t)}catch(e){console.log(e)}}async function z(){try{const e=await fetch("/api/wifiStaConnectInfo.json");if(!e.ok)throw new Error("Network response wasnt very cool");const t=await e.json();se(t)}catch(e){console.log(e)}}async function D(){try{const e=await fetch("/api/uptimeFunk.json");if(!e.ok)throw new Error("Network response was not ok");const t=await e.json();te(t)}catch(e){console.error("Error:",e)}}async function G(){try{const e=await fetch("/api/moduleInfo.json");if(!e.ok)throw new Error("Network response was not ok");const t=await e.json();m=t.module_info.type,console.log(m),S=t,Y(t),N(p(t.module_info.identifier),t),$(t),k(t),m==="controller"&&(I(),V())}catch(e){console.error("Error:",e)}}async function X(){try{const e=await fetch("/api/controllerStaList.json");if(!e.ok)throw new Error("Network response was not ok");const t=await e.json();q=Object.keys(t.sta_list),J(t)}catch{}}function J(e){const{sta_list:t}=e;Object.entries(t).forEach(([o,s])=>{const n=p(o);(async function(){try{const c=await fetch(`http://littlelisa-${n}.local/api/moduleInfo.json`);if(c.ok){const a=await c.json();document.querySelector(`.${n}`)===null&&(N(n,a),K(n,a,s),x.add(o)),Z(n,s)}else console.error(`${n} not a node`,error)}catch{}})()})}function K(e,t,o){const{module_info:{location:s,identifier:n}}=t;document.querySelector(".online-connections > .inside").insertAdjacentHTML("beforeend",`<a href="http://littlelisa-${e}.local"
        ...
        >`)}function N(e,t){const{module_info:{type:o,location:s,identifier:n},sensor_list:r}=t;document.querySelector(`.${e}`)!==null?document.querySelector(`.${e}`):document.querySelector(".section-sensor-data").insertAdjacentHTML("beforeend",` <!-- NODE- ${e}-->
...
`}),e&&(e.value=t)}function I(){X(),A(),ee()}function Y(e){const{module_info:{type:t,location:o,identifier:s}}=e;document.querySelector(".type").textContent=t,document.querySelector(".module_id").textContent=s,document.querySelector(".title-location").textContent=o}function Z(e,t){const o=document.querySelector(`.${e}-btn .rssi`),s=document.querySelector(`.${e}-btn .rssi-value`);t>-50?o.style.backgroundColor="green":t<-50&&t>-70?o.style.backgroundColor="yellow":t<-70?o.style.backgroundColor="red":t<-100&&(o.style.backgroundColor="grey"),s.textContent=`${t}`}function ee(){x.forEach(e=>{const t=p(e);!q.includes(e)&&document.querySelector(`.${t}`)!==null&&(document.querySelector(`.${t}`).remove(),document.querySelector(`.${t}-btn`).remove(),x.delete(e),console.log(`removed ${t}`))})}function te({uptime:e}){const t=[Math.floor(e/864e5),Math.floor(e%864e5/36e5),Math.floor(e%36e5/6e4),Math.floor(e%6e4/1e3)].map(o=>o.toString().padStart(2,"0"));document.querySelector(".uptime").textContent=`${t[0]} : ${t[1]} : ${t[2]} : ${t[3]}`}function oe(e){const{module_info:t,sensor_info:o}=e,s=p(t.identifier),n=document.querySelector(`.${s}`),r=n==null?void 0:n.querySelector(`.${o.sensor_type}`),c=r==null?void 0:r.querySelector(`.local-sensor-${t.sensor_id}`);c!=null&&(c.querySelector(".timestamp").textContent=o.timestamp,c.querySelector(".sensor-location").textContent=o.location,c.querySelector(".sensor-pin").textContent=o.sensor_pin,c.querySelector(".temp").textContent=`${o.data.temperature.toFixed(2)}`,c.querySelector(".hum").textContent=`${o.data.humidity.toFixed(2)}`)}function O(){document.querySelectorAll(".sensor-data-node-box").forEach(t=>{const o=t.querySelectorAll(".temp"),{sumTemp:s,count:n}=Array.from(o).reduce((c,a)=>{const d=Number(a.textContent);return Number.isNaN(d)||(c.sumTemp+=d,c.count++),c},{sumTemp:0,count:0}),r=n>0?s/n:0;t.querySelector(".sensor-avg").textContent=r.toFixed(2)})}function ne(e){const{chip_info:{num_cores:t,chip_type:o},app_info:{secure_ver:s,app_ver:n,proj_name:r,compile_info:{time:c,date:a,idf_ver:d}}}=e;document.querySelector(".device-info .proj-name").textContent=r,document.querySelector(".device-info .app-ver").textContent=n,document.querySelector(".device-info .sec-ver").textContent=s,document.querySelector(".device-info .cores").textContent=t,document.querySelector(".device-info .chip").textContent=o,document.querySelector(".device-info .time").textContent=c,document.querySelector(".device-info .date").textContent=a,document.querySelector(".device-info .idf-ver").textContent=d}function se(e){const{ip:t,netmask:o,gw:s,ap:n,rssi:r}=e;document.querySelector(".network-info .sta-ssid").textContent=n,document.querySelector(".network-info .rssi").textContent=r,document.querySelector(".network-info .ip").textContent=t,document.querySelector(".network-info .netmask").textContent=o,document.querySelector(".network-info .gateway").textContent=s}let b=0;function k(e){const{module_info:{type:t,identifier:o}}=e;let s=p(o);s=t+s.substring(s.indexOf("-")),l=new WebSocket(`ws://littlelisa-${s}.local:8080/ws/sensor`),l.onclose=n=>{if(!n.wasClean){let r=j(b);setTimeout(k,r),b++}},l.onopen=function(){console.log("sensor Data websocket connection established"),b=0},l.onmessage=n=>{oe(JSON.parse(n.data.replace(/\0+$/,"")))}}let w=0;function $(e,t){const{module_info:{type:o,identifier:s}}=e;let n=p(s);n=o+n.substring(n.indexOf("-")),i=new WebSocket(`ws://littlelisa-${n}.local:8080/ws/log`),i.onopen=function(){console.log("log data websocket connection established"),console.log("starting websocket log"),w=0,setTimeout(function(){i.send("start log")},1e3)},i.onclose=r=>{if(!r.wasClean){let c=j(w);setTimeout($,c),w++}},i.onmessage=r=>{v.classList.contains("hidden")?E(r.data,"log-output"):(E(r.data,"ota-log"),ce(r.data)),r.data.includes("ALL_NODE_UPDATES_COMPLETE")&&(console.log("Updating controller from SD..."),h.textContent="Updating Controller from SD..."),r.data.includes("REFRESH_DEBUG_PAGE")&&(console.log("OTA Update Complete. Refreshing page in 10 seconds..."),y.textContent="OTA Update Complete",h.textContent=`OTA Update Complete. Wifi Restarting - please ensure your reconnection.
Refreshing page in 10 seconds...`,setTimeout(()=>{window.location.reload()},1e4))},window.addEventListener("beforeunload",function(){i.send("stop log"),i.send(""),l.send("")})}function j(e){let s=Math.min(3e4,1e3*2**e);return console.log(`Reconnecting in ${s} ms`),s}function E(e,t){const s=document.querySelector(`.${t}`),n=s.scrollHeight-s.clientHeight<=s.scrollTop+1;if(s.value+=(s.value?`
`:"")+re(e),s.value.length>1e5){let r=s.value.length-1e5,c=s.value.substring(r);s.value=`...[truncated]...
`+c}n&&(s.scrollTop=s.scrollHeight)}function re(e){let t=e.substring(e.indexOf("("));return t=t.substring(0,t.indexOf("[")-1),t}function p(e){return"node-"+e.replaceAll(":","-")}function ce(e){const t=/.*UPDATING_NODE_(\d+).*/,o=e.match(t);o&&(y.textContent="Updating",h.textContent=`Updating node ${o[1]}...`,console.log(`Updating node ${o[1]}...`))}window.addEventListener("resize",()=>{console.log(`Viewport Width: ${window.innerWidth}, Viewport Height: ${window.innerHeight}`)});console.log(`Initial Viewport Width: ${window.innerWidth}, Initial Viewport Height: ${window.innerHeight}`);G();z();W();O();D();setInterval(()=>{m==="controller"&&I()},5e3);setInterval(O,5e3);setInterval(D,5e3);
