...
// relay 1===========================
   ...
   en_cntrl_arr[0].pin = CONFIG_ENV_CNTRL_PIN_1;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_1
    en_cntrl_arr[0].type = CONFIG_ENV_CNTRL_TYPE_1;

#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_1
    en_cntrl_arr[0].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_1;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_1
    en_cntrl_arr[0].state = CONFIG_ENV_CNTRL_STATE_1;
#endif

// Relay 2===================
#ifdef CONFIG_ENV_CNTRL_PIN_2
    en_cntrl_arr[1].pin = CONFIG_ENV_CNTRL_PIN_2;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_2
    en_cntrl_arr[1].type = CONFIG_ENV_CNTRL_TYPE_2;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_2
    en_cntrl_arr[1].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_2;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_2
    en_cntrl_arr[1].state = CONFIG_ENV_CNTRL_STATE_2;
#endif

// relay 3==============================
#ifdef CONFIG_ENV_CNTRL_PIN_3
    en_cntrl_arr[2].pin = CONFIG_ENV_CNTRL_PIN_3;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_3
    en_cntrl_arr[2].type = CONFIG_ENV_CNTRL_TYPE_3;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_3
    en_cntrl_arr[2].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_3;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_3
    en_cntrl_arr[2].state = CONFIG_ENV_CNTRL_STATE_3;
#endif

// relay 4==============================
#ifdef CONFIG_ENV_CNTRL_PIN_4
    en_cntrl_arr[3].pin = CONFIG_ENV_CNTRL_PIN_4;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_4
    en_cntrl_arr[3].type = CONFIG_ENV_CNTRL_TYPE_4;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_4
    en_cntrl_arr[3].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_4;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_4
    en_cntrl_arr[3].state = CONFIG_ENV_CNTRL_STATE_4;
#endif

// relay 5==============================
#ifdef CONFIG_ENV_CNTRL_PIN_5
    en_cntrl_arr[4].pin = CONFIG_ENV_CNTRL_PIN_5;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_5
    en_cntrl_arr[4].type = CONFIG_ENV_CNTRL_TYPE_5;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_5
    en_cntrl_arr[4].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_5;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_5
    en_cntrl_arr[4].state = CONFIG_ENV_CNTRL_STATE_5;
#endif

// relay 6==============================
#ifdef CONFIG_ENV_CNTRL_PIN_6
    en_cntrl_arr[5].pin = CONFIG_ENV_CNTRL_PIN_6;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_6
    en_cntrl_arr[5].type = CONFIG_ENV_CNTRL_TYPE_6;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_6
    en_cntrl_arr[5].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_6;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_6
    en_cntrl_arr[5].state = CONFIG_ENV_CNTRL_STATE_6;
#endif

// relay 7==============================
#ifdef CONFIG_ENV_CNTRL_PIN_7
    en_cntrl_arr[6].pin = CONFIG_ENV_CNTRL_PIN_7;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_7
    en_cntrl_arr[6].type = CONFIG_ENV_CNTRL_TYPE_7;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_7
    en_cntrl_arr[6].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_7;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_7
    en_cntrl_arr[6].state = CONFIG_ENV_CNTRL_STATE_7;
#endif

// relay 8==============================
#ifdef CONFIG_ENV_CNTRL_PIN_8
    en_cntrl_arr[7].pin = CONFIG_ENV_CNTRL_PIN_8;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_8
    en_cntrl_arr[7].type = CONFIG_ENV_CNTRL_TYPE_8;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_8
    en_cntrl_arr[7].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_8;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_8
    en_cntrl_arr[7].state = CONFIG_ENV_CNTRL_STATE_8;
#endif

// relay 9==============================
#ifdef CONFIG_ENV_CNTRL_PIN_9
    en_cntrl_arr[8].pin = CONFIG_ENV_CNTRL_PIN_9;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_9
    en_cntrl_arr[8].type = CONFIG_ENV_CNTRL_TYPE_9;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_9
    en_cntrl_arr[8].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_9;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_9
    en_cntrl_arr[8].state = CONFIG_ENV_CNTRL_STATE_9;
#endif

// relay 10==============================
#ifdef CONFIG_ENV_CNTRL_PIN_10
    en_cntrl_arr[9].pin = CONFIG_ENV_CNTRL_PIN_10;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_10
    en_cntrl_arr[9].type = CONFIG_ENV_CNTRL_TYPE_10;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_10
    en_cntrl_arr[9].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_10;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_10
    en_cntrl_arr[9].state = CONFIG_ENV_CNTRL_STATE_10;
#endif

// relay 11==============================
#ifdef CONFIG_ENV_CNTRL_PIN_11
    en_cntrl_arr[10].pin = CONFIG_ENV_CNTRL_PIN_11;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_11
    en_cntrl_arr[10].type = CONFIG_ENV_CNTRL_TYPE_11;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_11
    en_cntrl_arr[10].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_11;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_11
    en_cntrl_arr[10].state = CONFIG_ENV_CNTRL_STATE_11;
#endif

// relay 12==============================
#ifdef CONFIG_ENV_CNTRL_PIN_12
    en_cntrl_arr[11].pin = CONFIG_ENV_CNTRL_PIN_12;
#endif

#ifdef CONFIG_ENV_CNTRL_TYPE_12
    en_cntrl_arr[11].type = CONFIG_ENV_CNTRL_TYPE_12;
#endif
#ifdef CONFIG_ENV_CNTRL_EXT_PWR_12
    en_cntrl_arr[11].pwr_src = CONFIG_ENV_CNTRL_EXT_PWR_12;
#endif
#ifdef CONFIG_ENV_CNTRL_STATE_12
    en_cntrl_arr[11].state = CONFIG_ENV_CNTRL_STATE_12;
#endif
